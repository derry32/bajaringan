...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-dark ftco-navbar-light-2" id="ftco-navbar">
      ...
      <div class="container">
    	...
    	<div class="container-fluid">
    		<div class="row">
    			<?php $ambil = $koneksi->query("SELECT * FROM baja_benefits where id_benefits='$_GET[id]'");?>
                <?php while($perproduk = $ambil->fetch_assoc()){?>
                
                    
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="product">
    					<a href="" class="img-prod"><img class="img-fluid" src="foto_benefits/<?php echo $perproduk['foto_benefits'];?>" alt="Colorlib Template">
    					</a>
                ...
                <p align=justify><?php echo $perproduk ['deskripsi_benefits'];?></p>
                </div>
             <?php }?>
    		</div>
    	</div>
